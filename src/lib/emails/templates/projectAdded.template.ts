interface ProjectAddedEmailProps {
  userName: string;
  addedByName: string;
  projectName: string;
...
export function generateProjectAddedEmail({
  userName,
  addedByName,
  projectName,
  role,
  projectUrl,
}: ProjectAddedEmailProps): string {
    ...
    <tr>
      <td style="padding: 40px 0;">
        <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
          <!-- Header -->
          <tr>
            <td style="padding: 40px 40px 30px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); border-radius: 8px 8px 0 0;">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 32px; color: #4b5563; font-size: 16px; line-height: 1.6;">
                Great news! <strong>${addedByName}</strong> has added you to a project as a <strong>${roleLabel}</strong>.
              </p>
                    ...
                    <table role="presentation" style="width: 100%; border-collapse: collapse;">
                      ...
                      <tr>
                        <td style="padding-top: 12px; border-top: 1px solid #e5e7eb;">
                          ...
                          <p style="margin: 4px 0 0; color: #3b82f6; font-size: 16px; font-weight: 600;">${roleLabel}</p>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-top: 12px; border-top: 1px solid #e5e7eb;">
                          <span style="color: #6b7280; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;">Added By</span>
                          <p style="margin: 4px 0 0; color: #1f2937; font-size: 16px;">${addedByName}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" style="width: 100%; border-collapse: collapse; margin-top: 32px;">
                <tr>
                  <td style="text-align: center;">
                    <a href="${projectUrl}" style="display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(59, 130, 246, 0.25);">
                      View Project
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding: 24px 40px; background-color: #f9fafb; border-radius: 0 0 8px 8px; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; color: #9ca3af; font-size: 12px; line-height: 1.5; text-align: center;">
                ...
                If you have any questions, please contact ${addedByName}.
              </p>
            </td>
          </tr>
        </table>
